...
from .hero_name_mapper import load_hero_names, translate_hero_list
...
def get_model():
    ...
    if _model is None:
        try:
            ...
            raise RuntimeError(f"無法載入 BP 預測模型: {e}") from e
    return _model


def predict_winrate(
    team1_picks=None, team2_picks=None, team1_bans=None, team2_bans=None, team="blue"
):
    """預測勝率
    ...
    try:
        ...
        return {"winrate": winrate, "team": team, "translated_data": data}
    except Exception as e:
        return f"錯誤：預測失敗 - {e}"


def recommend_pick(
    team1_picks=None, team2_picks=None, team1_bans=None, team2_bans=None, team="blue", top_k=5
):
    """推薦選擇的英雄
...
def recommend_ban(
    team1_picks=None, team2_picks=None, team1_bans=None, team2_bans=None, target_team="red", top_k=5
):
    """推薦禁用的英雄
